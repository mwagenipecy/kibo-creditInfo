...
class NewShares extends Component
{
    ...
    public function save()
    {
        ...
        $savings_account_new_balance = (float) AccountsModel::where('account_number', $this->linked_savings_account)->value('balance') - ($this->number_of_shares * $this->nominal_price);
        $share_account_new_balance = (float) AccountsModel::where('account_number', $this->account_number)->value('balance') + ($this->number_of_shares * $this->nominal_price);
        $share_ledger_account_new_balance = (float) AccountsModel::where('account_number', '5111108827')->value('balance') + ($this->number_of_shares * $this->nominal_price);
