...
class Accounting extends Component
{
    ...
    public function issueAccounts()
    {
        ...
        $accounts_account_new_balance = (float) AccountsModel::where('account_number', $this->linked_accounts_account)->value('balance') - ($this->number_of_accounts * $this->nominal_price);
        $loan_account_new_balance = (float) AccountsModel::where('account_number', $this->account_number)->value('balance') + ($this->number_of_accounts * $this->nominal_price);
        $loan_ledger_account_new_balance = (float) AccountsModel::where('account_number', '5111108827')->value('balance') + ($this->number_of_accounts * $this->nominal_price);
