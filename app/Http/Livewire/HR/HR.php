...
class HR extends Component
{
    ...
    protected $listeners = ['leave_register_modal' => 'register_modal', 'departmentModalClose' => 'departmentModal', 'viewMemberDetailsForm' => 'viewMemberDetails',
    ...
    public function departmentDelete($id)
    {
        ...
        } elseif ($this->deleteDepartmentModal == true) {
    ...
    public function departmentEdit()
    {
        ...
        } elseif ($this->openEditDepartmentModal == true) {
    ...
    public function register_modal()
    {
        ...
        } elseif ($this->leave_register == true) {
