...
class general_ledger extends Model
{
    ...
    public function credit($credit_account_number, $credit_account_new_balance, $debit_account_number, $credit_amount, $naration, $loan_id)
    {
    ...
    public function creditWithReference($credit_account_number, $credit_account_new_balance, $debit_account_number, $credit_amount, $naration, $bank_reference_number)
    {
