        ...
        <div class="w-full h-full grid justify-items-center">
            ...
            <div class="flex justify-center px-4 pt-4 pb-4">
                ...
                <div class=" flex flex-row gap-2">
                        ...
                        <input wire:model.live.debounce="client_number" type="number" id="client_number" class="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-gray-900
