    ...
    <div class="bg-green-600 shadow-sm border-b-4 border-green-500">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="text-center">
                <h1 class="text-3xl font-bold text-white mb-2">Vehicle Insurance Calculator</h1>
                <p class="text-lg text-white mb-6">Professional insurance calculation for Tanzania</p>
                <div class="flex items-center justify-center space-x-8 text-sm text-white">
                ...
                <form wire:submit.prevent="submitContactForm">
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-semibold text-gray-900">Request Insurance Quote</h3>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input wire:model="customerName" type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-gray-500 focus:border-gray-500">
                                @error('customerName') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                            </div>
                            
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Phone Number *</label>
                                <input wire:model="customerPhone" type="tel" placeholder="+255 xxx xxx xxx" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-gray-500 focus:border-gray-500">
                                @error('customerPhone') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                            </div>
                            
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Email Address</label>
                                <input wire:model="customerEmail" type="email" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-gray-500 focus:border-gray-500">
                            ...
                            @if($calculationResults)
                                <div class="bg-gray-50 border border-gray-200 rounded-lg p-3">
                                    <div class="text-sm">
                                        <div class="font-medium text-gray-900">Complete Quote Summary</div>
                                        <div class="text-gray-700 text-xs mt-1">
                                            ...
                                            <strong class="text-gray-900">Total Premium: TSh {{ number_format($calculationResults['total_premium']) }}/year</strong>
                                        </div>
                                    </div>
                                </div>
                            @endif
...
function showNotification(type, message) {
    const colors = {
        success: { bg: 'bg-gray-100', text: 'text-gray-800', border: 'border-gray-300' },
